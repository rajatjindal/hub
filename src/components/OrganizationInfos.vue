<template>
  <div class="organization">
    ...
    <transition name="fade">
      <h5 v-if="!isLoading && username" class="organization-name">{{ username }}</h5>
      <div v-else class="loading-shimmer tag organization-name"></div>
    </transition>
    <transition name="fade">
      <h6 v-if="!isLoading && title" class="organization-title">{{ title }}</h6>
      <div v-else class="loading-shimmer tag organization-title"></div>
    </transition>
